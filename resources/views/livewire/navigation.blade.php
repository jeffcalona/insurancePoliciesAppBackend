<header class="bg-blue-500 sticky top-0" style="z-index: 900" x-data="{open_nav :false}">
    ...
    <nav class="bg-black border-gray-800 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
        ...
        <div class="flex items-center md:order-2">
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    ...
                    <button class="flex text-sm bg-white border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                        {{ Auth::user()->name }}
                    </button>

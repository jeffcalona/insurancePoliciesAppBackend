            ...
            <div class=" m-10">
                ...
                <form action="{{route('sure.update', $sure->id)}}" class="border bg-white shadow-md col-6 p-5" method="POST">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 mb-6 w-full group">
                            <input type="text" name="description" value="{{$sure->description}}" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="descripción " required="">
